...
@SourceType(value = "ShopifyARP", label = "Shopify",uiConfig = "shopify-layout.json")
public class ShopifyConf extends AbstractArpConf<ShopifyConf> {
  private static final String ARP_FILENAME = "arp/implementation/shopify-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.shopify.ShopifyDriver";
